...
public class Fighter2Test {
    ...
    public void shouldWorkWithNoMoves() {
        ...
        assertArrayEquals(solution, Fighter2.superStreetFighterize(fighters, new int[]{0,1}, new String[]{}));
    }
    ...
    public void shouldWorkWithFewMoves(){
        ...
        assertArrayEquals(solution, Fighter2.superStreetFighterize(fighters, position, moves));
    }
    ...
    private String[][] fighters3 = new String[][]{
    ...
    public void shouldRotateOnAllRows3(){
        ...
        assertArrayEquals(solution, Fighter2.superStreetFighterize(fighters3, position, moves));
    }
    ...
    private String[][] fighters4 = new String[][]{
    ...
    public void shouldWorkWithLongerGrid4(){
        ...
        assertArrayEquals(solution, Fighter2.superStreetFighterize(fighters4, position, moves));
    }
